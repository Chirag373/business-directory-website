...
class User(AbstractUser, TimeStampedModel):
    ...
    user_type = models.CharField(max_length=10, choices=UserType.choices, default=UserType.REQUESTOR)
...
class PromotionalEmailSent(TimeStampedModel):
    ...
    promotion = models.ForeignKey(PromotionalOffer, on_delete=models.CASCADE, related_name='emails_sent')
    recipient = models.ForeignKey(User, on_delete=models.CASCADE, related_name='promo_emails_received')

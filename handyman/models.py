...
class Handyman(TimeStampedModel):
    ...
    services = models.ManyToManyField(
        Service, through="HandymanService", related_name="handymen", blank=True
    )
    ...
    offers_promotions = models.BooleanField(
        default=False, help_text="Check if you want to offer promotional discounts"
    )
...
class HandymanService(TimeStampedModel):
    ...
    handyman = models.ForeignKey(
        Handyman, on_delete=models.CASCADE, related_name="handyman_services"
    )
    service = models.ForeignKey(
        Service, on_delete=models.CASCADE, related_name="handyman_services"
    )
...
class HandymanPromotion(TimeStampedModel):
    ...
    handyman = models.ForeignKey(
        Handyman, on_delete=models.CASCADE, related_name="promotions"
    )
    service = models.ForeignKey(
        Service,
        on_delete=models.CASCADE,
...
class HandymanJob(TimeStampedModel):
    ...
    handyman = models.ForeignKey(
        Handyman, on_delete=models.CASCADE, related_name="jobs"
    )
...
class PromotionNotification(TimeStampedModel):
    ...
    promotion = models.ForeignKey(
        HandymanPromotion, on_delete=models.CASCADE, related_name="notifications"
    )

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_areas', models.ManyToManyField(related_name='handymen', to='core.address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handyman', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handyman_services', to='handyman.handyman')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handyman_services', to='handyman.service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handyman_requests', to=settings.AUTH_USER_MODEL)),
                ('handyman', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='handyman.handyman')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='handyman.service')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='handyman',
            name='services',
            field=models.ManyToManyField(related_name='handymen', through='handyman.HandymanService', to='handyman.service'),
        ),
    ]

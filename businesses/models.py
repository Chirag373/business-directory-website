...
class Business(TimeStampedModel):
    ...
    address = models.ForeignKey(
        Address, on_delete=models.CASCADE, related_name="businesses"
    )
...
class BusinessHours(models.Model):
    ...
    business = models.ForeignKey(
        Business, on_delete=models.CASCADE, related_name="business_hours"
    )
...
class BusinessCard(TimeStampedModel):
    ...
    business = models.ForeignKey(
        Business, on_delete=models.CASCADE, related_name="business_cards"
    )
    front_image = models.ImageField(upload_to="business_cards/front/")
    back_image = models.ImageField(
        upload_to="business_cards/back/", blank=True, null=True
    )
